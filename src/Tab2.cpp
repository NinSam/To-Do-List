...
using namespace geode::prelude;
	...
	bool Tab2::init(){
		...
		CCMenuItemSpriteExtra* opensettings = CCMenuItemSpriteExtra::create(
			...
			this,
			menu_selector(Tab2::OpenSettings)
		);
		...
		CCMenuItemSpriteExtra* page_left = CCMenuItemSpriteExtra::create(
			...
			this,
			menu_selector(Tab2::PreviousTab)
		);
	...
	void Tab2::CloseTab(CCObject*){
		this->setTouchEnabled(false);
		this->removeFromParentAndCleanup(true);
 	}
	void Tab2::PreviousTab(CCObject*){
		
		this->setTouchEnabled(false);
		this->removeFromParentAndCleanup(true);
		Tab1::create()->show();
	}
	void Tab2::NextTab(CCObject*){
		
		this->setTouchEnabled(false);
		this->removeFromParentAndCleanup(true);
		Tab3::create()->show();
	}
	void Tab2::OpenSettings(CCObject*){
		geode::openSettingsPopup(Mod::get());
	}
	void Tab2::Info(CCObject*){
