...
bool Tab5::init(){
	...
	auto toggle = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox), 1);
	layout->addChild(toggle);
	toggle->setPosition(312, 234);
	toggle->toggle(Mod::get()->getSavedValue<bool>("checkbox-tab-5", false));

	auto toggle_2 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox2), 1);
	...
	auto toggle_3 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox3), 1);
	...
	auto toggle_4 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox4), 1);
	...
	auto toggle_5 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox5), 1);
	...
	auto toggle_6 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox6), 1);
	layout->addChild(toggle_6);
	toggle_6->setPosition(312, 34);
	toggle_6->toggle(Mod::get()->getSavedValue<bool>("checkbox-6-tab-5", false));

	auto toggle_7 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox7), 1);
	...
	auto toggle_8 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox8), 1);
	...
	auto toggle_9 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox9), 1);
	...
	auto toggle_10 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab5::SaveCheckbox10), 1);
