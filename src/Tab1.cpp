...
bool Tab1::init(){
	...
	auto input_1 = TextInput::create(200, str4, "bigFont.fnt");
	...
	auto input_2 = TextInput::create(200, str5, "bigFont.fnt");
	...
	auto input_3 = TextInput::create(200, str6, "bigFont.fnt");
    ...
    auto input_priority_1 = TextInput::create(50, str, "bigFont.fnt");
    ...
    auto input_priority_2 = TextInput::create(50, str2, "bigFont.fnt");
    ...
    auto input_priority_3 = TextInput::create(50, str3, "bigFont.fnt");
	...
	auto toggle = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox), 1);
	layout->addChild(toggle);
	toggle->setPosition(312, 234);
	toggle->toggle(Mod::get()->getSavedValue<bool>("checkbox-tab-1", false));

	auto toggle_2 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox2), 1);
	...
	auto toggle_3 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox3), 1);
	...
	auto toggle_4 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox4), 1);
	...
	auto toggle_5 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox5), 1);
	...
	auto toggle_6 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox6), 1);
	layout->addChild(toggle_6);
	toggle_6->setPosition(312, 34);
	toggle_6->toggle(Mod::get()->getSavedValue<bool>("checkbox-6-tab-1", false));

	auto toggle_7 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox7), 1);
	...
	auto toggle_8 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox8), 1);
	...
	auto toggle_9 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox9), 1);
	...
	auto toggle_10 = CCMenuItemToggler::createWithStandardSprites(this, menu_selector(Tab1::SaveCheckbox10), 1);
